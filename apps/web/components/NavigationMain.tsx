                    ...
                    <NavigationMenu>
                        <NavigationMenuList>
                                ...
                                <NavigationMenuContent>
                                    <ul className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                                        ...
                                        <ListItem
                                            ...
                                            title="Baies"
                                        >
                                            Découvrez les différentes baies,
                                            leurs saveurs et fermetés.
                                        </ListItem>
                                        <ListItem
                                            href="/pokemon/move"
                                            title="Capacités"
                                        >
                                            Explorez toutes les capacités et
                                            leurs effets.
                                        </ListItem>
                                        <ListItem
                                            href="/pokemon/ability"
                                            title="Talents"
                                        >
                                            Découvrez les talents et les Pokémon
                                            qui les possèdent.
                                        </ListItem>
                                        <ListItem
                                            href="/pokemon/create"
                                            title="Créateur"
                                        >
                                            Inventez votre propre Pokémon et
                                            générez un PDF.
                                        </ListItem>
                                    </ul>
                                </NavigationMenuContent>
                            ...
                            <NavigationMenuItem>
                                ...
                                <NavigationMenuContent>
                                    <ul className="grid p-4 md:w-[400px] lg:w-[400px] lg:grid-cols-[.75fr_1fr]">
